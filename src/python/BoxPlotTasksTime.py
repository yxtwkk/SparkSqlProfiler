...
filename="/Users/yxtwkk/Desktop/Profile/TPC-H-q14/StageInfo/Stage.txt"
AppName=[]
l1=[]
l2=[]
l3=[]
...
l=[l1,l2,l3,l4]
m=[l5,l6,l7,l8]
axes[0].boxplot(l, labels=label,sym='r*',whis='range',showfliers=False)
...
axes[1].boxplot(m, labels=label,sym='r*',whis='range',showfliers=False)
...
#plt.ylabel('Task.Duration(s)')
#plt.xlabel('Executor')
plt.savefig("/Users/yxtwkk/Desktop/Profile/TPC-H-q14/Image/TaskDuration.jpg")
plt.show()
